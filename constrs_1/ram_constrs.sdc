...
set_input_delay -max 1.0 [get_ports "oe"] -clock [get_clocks "CLK"]
set_input_delay -max 1.0 [get_ports "we"] -clock [get_clocks "CLK"]
set_input_delay -max 1.0 [get_ports "RST"] -clock [get_clocks "CLK"]
set_input_delay -max 1.0 [get_ports "addr"] -clock [get_clocks "CLK"]
